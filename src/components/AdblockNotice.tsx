...
export function AdblockNotice({
  ...
  return (
    <div
      ...
      onClick={(e) => {
        if (e.target === e.currentTarget) dismiss("sfondo");
      }}
    >
      <div
        role="dialog"
      ...
      >
        ...
        <div className="mt-5 space-y-4 text-[15px] leading-relaxed text-ink-soft">
          <p>
            Hai un blocco pubblicità attivo, e fai bene ad averlo: gran parte di internet se
            l&apos;è meritato.
          </p>
          <p>
            Qui però gli annunci pagano una cosa precisa. L&apos;archivio delle preghiere della
            tradizione — il Padre nostro, il Salmo 23, l&apos;eterno riposo, il Mi Sheberach, la
            Fātiḥa — è <strong className="font-medium text-ink">gratuito</strong>, senza
            registrazione e senza limiti, e resta così. Sono gli annunci a tenerlo aperto.
          </p>
          <p>
            Se puoi metterci fra le eccezioni, aiuti chi arriva qui alle tre di notte e non ha
            voglia di pagare per delle parole. Se non puoi o non vuoi,{" "}
            <strong className="font-medium text-ink">va bene lo stesso</strong>: entra e leggi.
            Non ti chiudiamo niente e non ti chiederemo altro.
          </p>
        </div>
