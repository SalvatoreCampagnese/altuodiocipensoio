...
export default function PrivacyPage() {
  return (
    ...
    >
      <Section h="1. Quali dati raccogliamo">
        <p>
      ...
      <Section h="2. Dati particolari, e perché serve un consenso a parte">
        <p>
      ...
      <Section h="3. Dati di altre persone">
        <p>
      ...
      <Section h="5. Decisioni automatizzate e intelligenza artificiale">
        <p>
      ...
      <Section h="6. A chi comunichiamo i dati">
        <p>
      ...
      <Section h="7. Per quanto tempo li conserviamo">
      ...
      <Section h="8. Chi può vedere le tue preghiere">
        <p>
