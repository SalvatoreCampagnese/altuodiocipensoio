...
export const HOLDER: Holder = {
  name: "Salvatore Campagnese",
  form: "ditta individuale",
  vat: "04254271200",
  // Codice fiscale personale (16 caratteri): per una ditta individuale è
  // diverso dalla partita IVA e va indicato. Da inserire.
  taxCode: "",
  address: "Via Fratelli Cervi 22, 40024 Castel San Pietro Terme (BO), Italia",
  rea: "", // se iscritto al Registro Imprese
  email: process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@altuodiocipensoio.com",
  // Domicilio digitale: obbligatorio per le imprese iscritte al Registro
  // Imprese e comunque atteso in un'informativa. Da inserire.
  pec: "",
};
